...
{
    public class StartProduktieMachineViewModel : FreshBasePageModel
    {
        ...
        public StartProduktieMachineViewModel(IBeukServices beukService, IMachineServices machineService)
        {
        ...
        public ICommand OpenMachinePageCommand => new Command<Machine>(async (Machine machine) => 
        {
            ...
            await CoreMethods.PushPageModel<StartProduktieOperatorViewModel>(currentStatus, false, true);
        });
